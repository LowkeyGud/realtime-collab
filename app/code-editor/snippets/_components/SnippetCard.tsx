...
function SnippetCard({ snippet }: { snippet: Snippet }) {
  ...
  return (
    ...
    >
      <Link
        href={`/code-editor/snippets/${snippet._id}`}
        className="h-full block"
      >
        <div
          className="relative h-full bg-card/80 backdrop-blur-sm rounded-xl 
        ...
        >
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h2 className="text-xl font-semibold text-foreground mb-2 line-clamp-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  {snippet.title}
                </h2>
              ...
              <div className="relative group/code">
                ...
                <pre className="relative bg-muted/50 dark:bg-black/30 rounded-lg p-4 overflow-hidden text-sm text-foreground font-mono line-clamp-3">
                  {snippet.code}
                </pre>
              </div>
            </div>
